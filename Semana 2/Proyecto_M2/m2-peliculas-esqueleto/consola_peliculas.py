...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict) -> None:
    ...
    """
    peli_mas_larga = mod.encontrar_pelicula_mas_larga(p1, p2, p3, p4, p5)
    mostrar_informacion_pelicula(peli_mas_larga)
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    print("duracion promedio: " + mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5) + "\n")
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    print(str(mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)))
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        hora = int(input("Ingrese la nueva hora: "))
        print("0 - Lunes\n" + \
        "1 - Martes\n" + \
        "2 - Miércoles\n" + \
        "3 - Jueves\n" + \
        ...
        "5 - Sábado\n" + \
        "6 - Domingo\n")
        dia_ix = int(input("Seleccione el dia de la nueva agenda: "))
        lista_dias = ["Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado", "Domingo"]
        control = input("Desea validar preferencias de agendamiento?\n0 - No\n1 - Sí\n")
        if control == "1":
            control = True
        else:
            control = False
        if (mod.reagendar_pelicula(pelicula, hora, lista_dias[dia_ix], control, p1, p2, p3, p4, p5)):
            print("Agendamiento realizado satisfactoriamente.\n")
        else:
            print("No se pudo realizar el agendamiento.\n")
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        autorizacion = input("Cuenta con autorización de los padres?\n0 - No\n1 - Sí\n")
        if autorizacion == "1":
            autorizacion = True
        else:
            autorizacion = False
        ...
        if mod.decidir_invitar(pelicula, edad, autorizacion):
            print("El invitado puede ver la película.\n")
        else:
            print("El invitado no puede ver la película.\n")
